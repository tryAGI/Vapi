...
namespace Vapi
{
    ...
    /// </summary>
    public static class FallbackElevenLabsTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this FallbackElevenLabsTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static FallbackElevenLabsTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
