...
namespace Vapi
{
    ...
    /// </summary>
    public static class NumberComparatorScorecardMetricConditionTypeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this NumberComparatorScorecardMetricConditionType value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static NumberComparatorScorecardMetricConditionType? ToEnum(string value)
        {
            return value switch
            {
