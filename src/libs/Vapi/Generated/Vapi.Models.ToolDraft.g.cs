...
namespace Vapi
{
    ...
    /// 
    /// </summary>
    public sealed partial class ToolDraft
    {
        /// <summary>
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.ToolDraftTypeJsonConverter))]
        public global::Vapi.ToolDraftType? Type { get; set; }
        ...
        /// <summary>
        /// This is the unique identifier for the tool this draft was forked from.<br/>
        /// Intentionally NOT a FK — `tool_draft` mirrors `tool_version` / `version_pin`'s<br/>
        /// no-FK / app-cleanup philosophy, so there is no `ON DELETE CASCADE`. Drafts<br/>
        /// must be cleaned up explicitly (`toolDraftDelete({ orgId, toolId })`) on a<br/>
        ...
        /// <summary>
        /// The published version this draft was forked from. Server defaults to<br/>
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.ToolDraftMethodJsonConverter))]
        public global::Vapi.ToolDraftMethod? Method { get; set; }
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.ToolDraftVerbJsonConverter))]
        public global::Vapi.ToolDraftVerb? Verb { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolDraft" /> class.
        /// </summary>
        /// <param name="id">
        /// Key used as `draftId` in URLs.
        /// </param>
        ...
        public ToolDraft(
            ...
            global::Vapi.ToolDraftType? type,
            string? createdBy,
            ...
            string? url,
            global::Vapi.ToolDraftMethod? method,
            ...
            global::Vapi.ToolDraftVerb? verb,
