...
namespace Vapi
{
    ...
    public sealed partial class EvalRunTargetAssistant
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.EvalRunTargetAssistantTypeJsonConverter))]
        public global::Vapi.EvalRunTargetAssistantType Type { get; set; }
        ...
        public EvalRunTargetAssistant(
            ...
            global::Vapi.EvalRunTargetAssistantType type,
            string? assistantId)
        {
