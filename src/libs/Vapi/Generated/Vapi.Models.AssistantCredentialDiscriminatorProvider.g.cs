    ...
    public static class AssistantCredentialDiscriminatorProviderExtensions
    {
        ...
        public static string ToValueString(this AssistantCredentialDiscriminatorProvider value)
        {
            return value switch
            {
                ...
                AssistantCredentialDiscriminatorProvider.Microsoft => "microsoft",
                ...
                AssistantCredentialDiscriminatorProvider.S3Compatible => "s3-compatible",
        ...
        public static AssistantCredentialDiscriminatorProvider? ToEnum(string value)
        {
            return value switch
            {
                ...
                "microsoft" => AssistantCredentialDiscriminatorProvider.Microsoft,
                ...
                "s3-compatible" => AssistantCredentialDiscriminatorProvider.S3Compatible,
