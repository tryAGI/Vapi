...
namespace Vapi
{
    ...
    /// </summary>
    public static class FallbackGladiaTranscriberLanguagesExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this FallbackGladiaTranscriberLanguages value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static FallbackGladiaTranscriberLanguages? ToEnum(string value)
        {
            return value switch
            {
