...
namespace Vapi
{
    public partial class SimulationScenariosClient
    {
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement s_ScenarioControllerUpdateSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_ScenarioControllerUpdateSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_ScenarioControllerUpdateSecurityRequirement0,
            };
        partial void PrepareScenarioControllerUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref string? xClientSource,
            ref string? xSimulationEntryPoint,
            global::Vapi.UpdateScenarioDTO request);
        partial void PrepareScenarioControllerUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Vapi.UpdateScenarioDTO request);
        partial void ProcessScenarioControllerUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessScenarioControllerUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.Scenario> ScenarioControllerUpdateAsync(
            global::System.Guid id,
        ...
        {
            var __response = await ScenarioControllerUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse<global::Vapi.Scenario>> ScenarioControllerUpdateAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareScenarioControllerUpdateArguments(
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ScenarioControllerUpdateSecurityRequirements,
                operationName: "ScenarioControllerUpdateAsync");
            ...
            if (xSimulationEntryPoint != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareScenarioControllerUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ScenarioControllerUpdate",
                                methodName: "ScenarioControllerUpdateAsync",
                                pathTemplate: "$\"/eval/simulation/scenario/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessScenarioControllerUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessScenarioControllerUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.Scenario> ScenarioControllerUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vapi.UpdateScenarioDTO
            {
                Name = name,
            ...
            return await ScenarioControllerUpdateAsync(
                id: id,
                xClientSource: xClientSource,
                xSimulationEntryPoint: xSimulationEntryPoint,
                request: __request,
