...
namespace Vapi
{
    ...
    public static class UpdateAssistantDTOServerMessageExtensions
    {
        ...
        public static string ToValueString(this UpdateAssistantDTOServerMessage value)
        {
            return value switch
            {
                UpdateAssistantDTOServerMessage.AssistantSpeechStarted => "assistant.speechStarted",
                UpdateAssistantDTOServerMessage.AssistantStarted => "assistant.started",
                UpdateAssistantDTOServerMessage.CallArtifactUpload => "call.artifact.upload",
                ...
                UpdateAssistantDTOServerMessage.TranscripttranscriptType__final_ => "transcript[transcriptType=\"final\"]",
        ...
        public static UpdateAssistantDTOServerMessage? ToEnum(string value)
        {
            return value switch
            {
                "assistant.speechStarted" => UpdateAssistantDTOServerMessage.AssistantSpeechStarted,
                "assistant.started" => UpdateAssistantDTOServerMessage.AssistantStarted,
                "call.artifact.upload" => UpdateAssistantDTOServerMessage.CallArtifactUpload,
                ...
                "transcript[transcriptType=\"final\"]" => UpdateAssistantDTOServerMessage.TranscripttranscriptType__final_,
