...
namespace Vapi
{
    ...
    /// </summary>
    public static class FallbackCartesiaTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this FallbackCartesiaTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static FallbackCartesiaTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
