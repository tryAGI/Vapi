...
namespace Vapi
{
    ...
    public sealed partial class TransferDestinationSip
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.TransferDestinationSipTypeJsonConverter))]
        public global::Vapi.TransferDestinationSipType Type { get; set; }
        ...
        public TransferDestinationSip(
            ...
            global::Vapi.TransferDestinationSipType type,
            string? callerId,
