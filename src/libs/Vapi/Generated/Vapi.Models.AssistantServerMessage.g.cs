...
namespace Vapi
{
    ...
    public static class AssistantServerMessageExtensions
    {
        ...
        public static string ToValueString(this AssistantServerMessage value)
        {
            return value switch
            {
                AssistantServerMessage.AssistantSpeechStarted => "assistant.speechStarted",
                AssistantServerMessage.AssistantStarted => "assistant.started",
                AssistantServerMessage.CallArtifactUpload => "call.artifact.upload",
                ...
                AssistantServerMessage.TranscripttranscriptType__final_ => "transcript[transcriptType=\"final\"]",
        ...
        public static AssistantServerMessage? ToEnum(string value)
        {
            return value switch
            {
                "assistant.speechStarted" => AssistantServerMessage.AssistantSpeechStarted,
                "assistant.started" => AssistantServerMessage.AssistantStarted,
                "call.artifact.upload" => AssistantServerMessage.CallArtifactUpload,
                ...
                "transcript[transcriptType=\"final\"]" => AssistantServerMessage.TranscripttranscriptType__final_,
