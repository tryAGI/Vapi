...
namespace Vapi
{
    ...
    /// </summary>
    public static class UpdateAssistantDraftDTOFirstMessageModeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this UpdateAssistantDraftDTOFirstMessageMode value)
        {
            return value switch
            {
                UpdateAssistantDraftDTOFirstMessageMode.AssistantSpeaksFirst => "assistant-speaks-first",
                UpdateAssistantDraftDTOFirstMessageMode.AssistantSpeaksFirstWithModelGeneratedMessage => "assistant-speaks-first-with-model-generated-message",
                UpdateAssistantDraftDTOFirstMessageMode.AssistantWaitsForUser => "assistant-waits-for-user",
        ...
        /// </summary>
        public static UpdateAssistantDraftDTOFirstMessageMode? ToEnum(string value)
        {
            return value switch
            {
                "assistant-speaks-first" => UpdateAssistantDraftDTOFirstMessageMode.AssistantSpeaksFirst,
                "assistant-speaks-first-with-model-generated-message" => UpdateAssistantDraftDTOFirstMessageMode.AssistantSpeaksFirstWithModelGeneratedMessage,
                "assistant-waits-for-user" => UpdateAssistantDraftDTOFirstMessageMode.AssistantWaitsForUser,
                _ => null,
            };
        }
    }
