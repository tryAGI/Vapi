...
namespace Vapi
{
    ...
    public sealed partial class CreateOrgDTO
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.CreateOrgDTOChannelJsonConverter))]
        public global::Vapi.CreateOrgDTOChannel? Channel { get; set; }
        ...
        public CreateOrgDTO(
            ...
            string? name,
            global::Vapi.CreateOrgDTOChannel? channel,
            double? billingLimit,
