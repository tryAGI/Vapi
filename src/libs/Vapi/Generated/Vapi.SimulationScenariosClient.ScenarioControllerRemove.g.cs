...
namespace Vapi
{
    public partial class SimulationScenariosClient
    {
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement s_ScenarioControllerRemoveSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_ScenarioControllerRemoveSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_ScenarioControllerRemoveSecurityRequirement0,
            };
        ...
        partial void ProcessScenarioControllerRemoveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ScenarioControllerRemoveSecurityRequirements,
                operationName: "ScenarioControllerRemoveAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ScenarioControllerRemove",
                                methodName: "ScenarioControllerRemoveAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessScenarioControllerRemoveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                global::Vapi.ScenarioInUseConflictResponseDTO? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::Vapi.ScenarioInUseConflictResponseDTO.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Vapi.ApiException<global::Vapi.ScenarioInUseConflictResponseDTO>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessScenarioControllerRemoveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
