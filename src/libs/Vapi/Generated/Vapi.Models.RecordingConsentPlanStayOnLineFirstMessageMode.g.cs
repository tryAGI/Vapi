...
namespace Vapi
{
    ...
    /// </summary>
    public static class RecordingConsentPlanStayOnLineFirstMessageModeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this RecordingConsentPlanStayOnLineFirstMessageMode value)
        {
            return value switch
            {
                RecordingConsentPlanStayOnLineFirstMessageMode.AssistantSpeaksFirst => "assistant-speaks-first",
                RecordingConsentPlanStayOnLineFirstMessageMode.AssistantWaitsForUser => "assistant-waits-for-user",
        ...
        /// </summary>
        public static RecordingConsentPlanStayOnLineFirstMessageMode? ToEnum(string value)
        {
            return value switch
            {
                "assistant-speaks-first" => RecordingConsentPlanStayOnLineFirstMessageMode.AssistantSpeaksFirst,
                "assistant-waits-for-user" => RecordingConsentPlanStayOnLineFirstMessageMode.AssistantWaitsForUser,
                _ => null,
            };
        }
    }
