...
namespace Vapi
{
    public partial class SimulationRunsClient
    {
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement s_SimulationRunControllerCreateSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_SimulationRunControllerCreateSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_SimulationRunControllerCreateSecurityRequirement0,
            };
        ...
        partial void ProcessSimulationRunControllerCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.CreateSimulationRunResponse> SimulationRunControllerCreateAsync(
        ...
        {
            var __response = await SimulationRunControllerCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse<global::Vapi.CreateSimulationRunResponse>> SimulationRunControllerCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SimulationRunControllerCreateSecurityRequirements,
                operationName: "SimulationRunControllerCreateAsync");
            ...
            if (userAgent != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSimulationRunControllerCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SimulationRunControllerCreate",
                                methodName: "SimulationRunControllerCreateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSimulationRunControllerCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The organization is not eligible to start this run.
                            if ((int)__response.StatusCode == 402)
                            {
                                string? __content_402 = null;
                                global::System.Exception? __exception_402 = null;
                                global::Vapi.SimulationRunPaymentRequiredResponse? __value_402 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_402 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_402 = global::Vapi.SimulationRunPaymentRequiredResponse.FromJson(__content_402, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_402 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Vapi.ApiException<global::Vapi.SimulationRunPaymentRequiredResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSimulationRunControllerCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vapi.CreateSimulationRunResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vapi.AutoSDKHttpResponse<global::Vapi.CreateSimulationRunResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vapi.CreateSimulationRunResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.CreateSimulationRunResponse> SimulationRunControllerCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vapi.CreateSimulationRunDTO
            {
