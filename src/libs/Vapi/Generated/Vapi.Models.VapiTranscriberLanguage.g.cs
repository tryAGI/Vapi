...
namespace Vapi
{
    ...
    /// </summary>
    public static class VapiTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this VapiTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static VapiTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
