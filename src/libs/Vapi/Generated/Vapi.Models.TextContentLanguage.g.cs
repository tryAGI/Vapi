...
namespace Vapi
{
    ...
    /// </summary>
    public static class TextContentLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this TextContentLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static TextContentLanguage? ToEnum(string value)
        {
            return value switch
            {
