...
namespace Vapi
{
    ...
    public sealed partial class VoiceCost
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.VoiceCostTypeJsonConverter))]
        public global::Vapi.VoiceCostType Type { get; set; }
        ...
        public VoiceCost(
            ...
            double characters,
            double cost,
            global::Vapi.VoiceCostType type)
        {
            this.Type = type;
