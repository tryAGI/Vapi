...
namespace Vapi
{
    ...
    public static class CampaignControllerFindAllStatusExtensions
    {
        ...
        public static string ToValueString(this CampaignControllerFindAllStatus value)
        {
            return value switch
            {
                CampaignControllerFindAllStatus.Archived => "archived",
                CampaignControllerFindAllStatus.Cancelled => "cancelled",
        ...
        public static CampaignControllerFindAllStatus? ToEnum(string value)
        {
            return value switch
            {
                "archived" => CampaignControllerFindAllStatus.Archived,
                "cancelled" => CampaignControllerFindAllStatus.Cancelled,
