...
namespace Vapi
{
    ...
    public sealed partial class Org
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.OrgChannelJsonConverter))]
        public global::Vapi.OrgChannel? Channel { get; set; }
        ...
        public Org(
            ...
            double? minutesUsed,
            string? name,
            global::Vapi.OrgChannel? channel,
            double? billingLimit,
