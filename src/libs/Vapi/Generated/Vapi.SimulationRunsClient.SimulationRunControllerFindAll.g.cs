...
namespace Vapi
{
    public partial class SimulationRunsClient
    {


        private static readonly global::Vapi.EndPointSecurityRequirement s_SimulationRunControllerFindAllSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_SimulationRunControllerFindAllSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_SimulationRunControllerFindAllSecurityRequirement0,
            };
        partial void PrepareSimulationRunControllerFindAllArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Vapi.SimulationRunControllerFindAllStatus? status,
            ref global::Vapi.SimulationRunControllerFindAllFilterStatus? filterStatus,
            ref global::Vapi.SimulationRunControllerFindAllTargetType? targetType,
            ref global::System.Guid? targetId,
            ref double? page,
            ref global::Vapi.SimulationRunControllerFindAllSortOrder? sortOrder,
            ref global::Vapi.SimulationRunControllerFindAllSortBy? sortBy,
            ref double? limit,
        ...
        partial void PrepareSimulationRunControllerFindAllRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Vapi.SimulationRunControllerFindAllStatus? status,
            global::Vapi.SimulationRunControllerFindAllFilterStatus? filterStatus,
            global::Vapi.SimulationRunControllerFindAllTargetType? targetType,
            global::System.Guid? targetId,
            double? page,
            global::Vapi.SimulationRunControllerFindAllSortOrder? sortOrder,
            global::Vapi.SimulationRunControllerFindAllSortBy? sortBy,
            double? limit,
        ...
        partial void ProcessSimulationRunControllerFindAllResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSimulationRunControllerFindAllResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.OneOf<global::System.Collections.Generic.IList<global::Vapi.SimulationRun>, global::Vapi.SimulationRunsPaginatedResponse>> SimulationRunControllerFindAllAsync(
        ...
        {
            var __response = await SimulationRunControllerFindAllAsResponseAsync(
                status: status,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse<global::Vapi.OneOf<global::System.Collections.Generic.IList<global::Vapi.SimulationRun>, global::Vapi.SimulationRunsPaginatedResponse>>> SimulationRunControllerFindAllAsResponseAsync(
            global::Vapi.SimulationRunControllerFindAllStatus? status = default,
            global::Vapi.SimulationRunControllerFindAllFilterStatus? filterStatus = default,
            global::Vapi.SimulationRunControllerFindAllTargetType? targetType = default,
            global::System.Guid? targetId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSimulationRunControllerFindAllArguments(
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SimulationRunControllerFindAllSecurityRequirements,
                operationName: "SimulationRunControllerFindAllAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("filterStatus", filterStatus?.ToValueString())
                                .AddOptionalParameter("targetType", targetType?.ToValueString())
                                .AddOptionalParameter("targetId", targetId?.ToString())
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSimulationRunControllerFindAllRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SimulationRunControllerFindAll",
                                methodName: "SimulationRunControllerFindAllAsync",
                                pathTemplate: "\"/eval/simulation/run\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSimulationRunControllerFindAllResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSimulationRunControllerFindAllResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vapi.OneOf<global::System.Collections.Generic.IList<global::Vapi.SimulationRun>, global::Vapi.SimulationRunsPaginatedResponse>.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vapi.AutoSDKHttpResponse<global::Vapi.OneOf<global::System.Collections.Generic.IList<global::Vapi.SimulationRun>, global::Vapi.SimulationRunsPaginatedResponse>>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vapi.OneOf<global::System.Collections.Generic.IList<global::Vapi.SimulationRun>, global::Vapi.SimulationRunsPaginatedResponse>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
