...
namespace Vapi
{
    ...
    /// </summary>
    public static class LMNTVoiceLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this LMNTVoiceLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static LMNTVoiceLanguage? ToEnum(string value)
        {
            return value switch
            {
