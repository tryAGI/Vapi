...
namespace Vapi
{
    ...
    /// </summary>
    public static class FallbackOpenAITranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this FallbackOpenAITranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static FallbackOpenAITranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
