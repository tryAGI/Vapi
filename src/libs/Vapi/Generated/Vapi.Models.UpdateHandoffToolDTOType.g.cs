...
namespace Vapi
{
    ...
    /// ---
    /// </summary>
    public enum UpdateHandoffToolDTOType
    {
        /// <summary>
    ...
    /// </summary>
    public static class UpdateHandoffToolDTOTypeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this UpdateHandoffToolDTOType value)
        {
            return value switch
            {
                UpdateHandoffToolDTOType.Handoff => "handoff",
        ...
        /// </summary>
        public static UpdateHandoffToolDTOType? ToEnum(string value)
        {
            return value switch
            {
                "handoff" => UpdateHandoffToolDTOType.Handoff,
                _ => null,
            };
        }
    }
