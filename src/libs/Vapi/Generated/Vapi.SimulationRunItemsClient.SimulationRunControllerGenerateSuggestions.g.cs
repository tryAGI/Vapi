...
namespace Vapi
{
    public partial class SimulationRunItemsClient
    {
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement s_SimulationRunControllerGenerateSuggestionsSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_SimulationRunControllerGenerateSuggestionsSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_SimulationRunControllerGenerateSuggestionsSecurityRequirement0,
            };
        partial void PrepareSimulationRunControllerGenerateSuggestionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string itemId,
            ref string force,
            ref string? persist);
        partial void PrepareSimulationRunControllerGenerateSuggestionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string force,
            string? persist);
        partial void ProcessSimulationRunControllerGenerateSuggestionsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task SimulationRunControllerGenerateSuggestionsAsync(
            string id,
            string itemId,
            string force,
        ...
        {
            await SimulationRunControllerGenerateSuggestionsAsResponseAsync(
                id: id,
                itemId: itemId,
                force: force,
                persist: persist,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse> SimulationRunControllerGenerateSuggestionsAsResponseAsync(
            string id,
            string itemId,
            string force,
            string? persist = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSimulationRunControllerGenerateSuggestionsArguments(
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SimulationRunControllerGenerateSuggestionsSecurityRequirements,
                operationName: "SimulationRunControllerGenerateSuggestionsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("persist", persist)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSimulationRunControllerGenerateSuggestionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SimulationRunControllerGenerateSuggestions",
                                methodName: "SimulationRunControllerGenerateSuggestionsAsync",
                                pathTemplate: "$\"/eval/simulation/run/{id}/item/{itemId}/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSimulationRunControllerGenerateSuggestionsResponse(
                    httpClient: HttpClient,
