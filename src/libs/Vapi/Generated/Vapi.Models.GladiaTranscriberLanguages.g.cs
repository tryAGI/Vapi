...
namespace Vapi
{
    ...
    /// </summary>
    public static class GladiaTranscriberLanguagesExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this GladiaTranscriberLanguages value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static GladiaTranscriberLanguages? ToEnum(string value)
        {
            return value switch
            {
