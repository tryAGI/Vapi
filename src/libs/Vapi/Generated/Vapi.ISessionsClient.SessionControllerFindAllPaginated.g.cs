...
namespace Vapi
{
    public partial interface ISessionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse<global::Vapi.SessionPaginatedResponse>> SessionControllerFindAllPaginatedAsResponseAsync(
            string? id = default,
            string? name = default,
            string? assistantId = default,
            string? assistantIdAny = default,
