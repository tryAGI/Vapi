...
namespace Vapi
{
    public partial class SimulationPersonalitiesClient
    {


        private static readonly global::Vapi.EndPointSecurityRequirement s_PersonalityControllerFindAllSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_PersonalityControllerFindAllSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_PersonalityControllerFindAllSecurityRequirement0,
            };
        partial void PreparePersonalityControllerFindAllArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref double? page,
            ref global::Vapi.PersonalityControllerFindAllSortOrder? sortOrder,
            ref global::Vapi.PersonalityControllerFindAllSortBy? sortBy,
            ref double? limit,
        ...
        partial void PreparePersonalityControllerFindAllRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            double? page,
            global::Vapi.PersonalityControllerFindAllSortOrder? sortOrder,
            global::Vapi.PersonalityControllerFindAllSortBy? sortBy,
            double? limit,
        ...
        partial void ProcessPersonalityControllerFindAllResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPersonalityControllerFindAllResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Vapi.Personality>> PersonalityControllerFindAllAsync(
            double? page = default,
            global::Vapi.PersonalityControllerFindAllSortOrder? sortOrder = default,
            global::Vapi.PersonalityControllerFindAllSortBy? sortBy = default,
        ...
        {
            var __response = await PersonalityControllerFindAllAsResponseAsync(
                page: page,
                sortOrder: sortOrder,
                sortBy: sortBy,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Vapi.Personality>>> PersonalityControllerFindAllAsResponseAsync(
            double? page = default,
            global::Vapi.PersonalityControllerFindAllSortOrder? sortOrder = default,
            global::Vapi.PersonalityControllerFindAllSortBy? sortBy = default,
            double? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePersonalityControllerFindAllArguments(
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PersonalityControllerFindAllSecurityRequirements,
                operationName: "PersonalityControllerFindAllAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePersonalityControllerFindAllRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PersonalityControllerFindAll",
                                methodName: "PersonalityControllerFindAllAsync",
                                pathTemplate: "\"/eval/simulation/personality\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPersonalityControllerFindAllResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPersonalityControllerFindAllResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Vapi.Personality>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::Vapi.Personality>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vapi.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Vapi.Personality>>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Vapi.Personality>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::Vapi.Personality>), JsonSerializerContext).ConfigureAwait(false) ??
