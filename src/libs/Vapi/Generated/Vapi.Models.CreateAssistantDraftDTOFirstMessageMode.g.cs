...
namespace Vapi
{
    ...
    /// </summary>
    public static class CreateAssistantDraftDTOFirstMessageModeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this CreateAssistantDraftDTOFirstMessageMode value)
        {
            return value switch
            {
                CreateAssistantDraftDTOFirstMessageMode.AssistantSpeaksFirst => "assistant-speaks-first",
                CreateAssistantDraftDTOFirstMessageMode.AssistantSpeaksFirstWithModelGeneratedMessage => "assistant-speaks-first-with-model-generated-message",
                CreateAssistantDraftDTOFirstMessageMode.AssistantWaitsForUser => "assistant-waits-for-user",
        ...
        /// </summary>
        public static CreateAssistantDraftDTOFirstMessageMode? ToEnum(string value)
        {
            return value switch
            {
                "assistant-speaks-first" => CreateAssistantDraftDTOFirstMessageMode.AssistantSpeaksFirst,
                "assistant-speaks-first-with-model-generated-message" => CreateAssistantDraftDTOFirstMessageMode.AssistantSpeaksFirstWithModelGeneratedMessage,
                "assistant-waits-for-user" => CreateAssistantDraftDTOFirstMessageMode.AssistantWaitsForUser,
                _ => null,
            };
        }
    }
