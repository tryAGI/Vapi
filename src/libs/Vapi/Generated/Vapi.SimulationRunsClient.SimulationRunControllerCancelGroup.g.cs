...
namespace Vapi
{
    public partial class SimulationRunsClient
    {
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement s_SimulationRunControllerCancelGroupSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_SimulationRunControllerCancelGroupSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_SimulationRunControllerCancelGroupSecurityRequirement0,
            };
        partial void PrepareSimulationRunControllerCancelGroupArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref string? xClientSource,
            ref string? xSimulationEntryPoint);
        partial void PrepareSimulationRunControllerCancelGroupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            string? xClientSource,
            string? xSimulationEntryPoint);
        partial void ProcessSimulationRunControllerCancelGroupResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSimulationRunControllerCancelGroupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.SimulationRun> SimulationRunControllerCancelGroupAsync(
            global::System.Guid id,
        ...
        {
            var __response = await SimulationRunControllerCancelGroupAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse<global::Vapi.SimulationRun>> SimulationRunControllerCancelGroupAsResponseAsync(
            global::System.Guid id,
            string? xClientSource = default,
            string? xSimulationEntryPoint = default,
            global::Vapi.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSimulationRunControllerCancelGroupArguments(
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SimulationRunControllerCancelGroupSecurityRequirements,
                operationName: "SimulationRunControllerCancelGroupAsync");
            ...
            if (xSimulationEntryPoint != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSimulationRunControllerCancelGroupRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SimulationRunControllerCancelGroup",
                                methodName: "SimulationRunControllerCancelGroupAsync",
                                pathTemplate: "$\"/eval/simulation/run/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSimulationRunControllerCancelGroupResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSimulationRunControllerCancelGroupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vapi.SimulationRun.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vapi.AutoSDKHttpResponse<global::Vapi.SimulationRun>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vapi.SimulationRun.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
