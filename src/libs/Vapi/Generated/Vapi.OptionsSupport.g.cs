...
namespace Vapi
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Vapi.AutoSDKRetryOptions Retry { get; set; } = new global::Vapi.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Vapi.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Vapi.IAutoSDKHook>();
        ...
        public global::Vapi.AutoSDKClientOptions AddHook(
            global::Vapi.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Vapi.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Vapi.AutoSDKClientOptions UseAuthorizationProvider(
            global::Vapi.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Vapi.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Vapi.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Vapi.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Vapi.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Vapi.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Vapi.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Vapi.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Vapi.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Vapi.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Vapi.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Vapi.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Vapi.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Vapi.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Vapi.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Vapi.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Vapi.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Vapi.AutoSDKClientOptions clientOptions,
            global::Vapi.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Vapi.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Vapi.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Vapi.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Vapi.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Vapi.IAutoSDKHook, global::Vapi.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Vapi.AutoSDKHookContext context)
        {
