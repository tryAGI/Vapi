...
namespace Vapi
{
    ...
    public static class UpdateAssistantDTOClientMessageExtensions
    {
        ...
        public static string ToValueString(this UpdateAssistantDTOClientMessage value)
        {
            return value switch
            {
                UpdateAssistantDTOClientMessage.AssistantSpeechStarted => "assistant.speechStarted",
        ...
        public static UpdateAssistantDTOClientMessage? ToEnum(string value)
        {
            return value switch
            {
                "assistant.speechStarted" => UpdateAssistantDTOClientMessage.AssistantSpeechStarted,
