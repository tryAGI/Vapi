...
namespace Vapi
{
    ...
    /// </summary>
    public static class SonioxTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this SonioxTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static SonioxTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
