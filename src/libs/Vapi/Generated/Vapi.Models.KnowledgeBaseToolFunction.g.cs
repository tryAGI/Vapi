...
namespace Vapi
{
    ...
    public sealed partial class KnowledgeBaseToolFunction
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Vapi.OpenAIFunctionParameters Parameters { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KnowledgeBaseToolFunction" /> class.
        /// </summary>
        /// <param name="name">
        /// This is the the name of the function to be called.<br/>
        /// Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64.
...
#endif
        public KnowledgeBaseToolFunction(
            string name,
            string description,
            global::Vapi.OpenAIFunctionParameters parameters,
            bool? strict)
        {
