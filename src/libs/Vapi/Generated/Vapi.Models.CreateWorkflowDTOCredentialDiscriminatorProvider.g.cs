    ...
    public static class CreateWorkflowDTOCredentialDiscriminatorProviderExtensions
    {
        ...
        public static string ToValueString(this CreateWorkflowDTOCredentialDiscriminatorProvider value)
        {
            return value switch
            {
                ...
                CreateWorkflowDTOCredentialDiscriminatorProvider.Microsoft => "microsoft",
                ...
                CreateWorkflowDTOCredentialDiscriminatorProvider.S3Compatible => "s3-compatible",
        ...
        public static CreateWorkflowDTOCredentialDiscriminatorProvider? ToEnum(string value)
        {
            return value switch
            {
                ...
                "microsoft" => CreateWorkflowDTOCredentialDiscriminatorProvider.Microsoft,
                ...
                "s3-compatible" => CreateWorkflowDTOCredentialDiscriminatorProvider.S3Compatible,
