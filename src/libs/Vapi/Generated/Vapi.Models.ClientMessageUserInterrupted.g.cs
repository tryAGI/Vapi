...
namespace Vapi
{
    ...
    public sealed partial class ClientMessageUserInterrupted
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.ClientMessageUserInterruptedTypeJsonConverter))]
        public global::Vapi.ClientMessageUserInterruptedType Type { get; set; }
