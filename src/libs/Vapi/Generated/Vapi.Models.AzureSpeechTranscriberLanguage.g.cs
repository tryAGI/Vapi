...
namespace Vapi
{
    ...
    /// </summary>
    public static class AzureSpeechTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this AzureSpeechTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static AzureSpeechTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
