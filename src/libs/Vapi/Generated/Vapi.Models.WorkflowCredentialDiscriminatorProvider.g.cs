    ...
    public static class WorkflowCredentialDiscriminatorProviderExtensions
    {
        ...
        public static string ToValueString(this WorkflowCredentialDiscriminatorProvider value)
        {
            return value switch
            {
                ...
                WorkflowCredentialDiscriminatorProvider.Microsoft => "microsoft",
                ...
                WorkflowCredentialDiscriminatorProvider.S3Compatible => "s3-compatible",
        ...
        public static WorkflowCredentialDiscriminatorProvider? ToEnum(string value)
        {
            return value switch
            {
                ...
                "microsoft" => WorkflowCredentialDiscriminatorProvider.Microsoft,
                ...
                "s3-compatible" => WorkflowCredentialDiscriminatorProvider.S3Compatible,
