...
namespace Vapi
{
    ...
    /// </summary>
    public static class SpeechmaticsTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this SpeechmaticsTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static SpeechmaticsTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
