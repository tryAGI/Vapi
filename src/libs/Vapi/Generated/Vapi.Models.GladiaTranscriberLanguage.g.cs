...
namespace Vapi
{
    ...
    /// </summary>
    public static class GladiaTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this GladiaTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static GladiaTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
