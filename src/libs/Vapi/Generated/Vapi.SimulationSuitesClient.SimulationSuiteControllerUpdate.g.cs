...
namespace Vapi
{
    public partial class SimulationSuitesClient
    {
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement s_SimulationSuiteControllerUpdateSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_SimulationSuiteControllerUpdateSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_SimulationSuiteControllerUpdateSecurityRequirement0,
            };
        partial void PrepareSimulationSuiteControllerUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref string? xClientSource,
            ref string? xSimulationEntryPoint,
            global::Vapi.UpdateSimulationSuiteDTO request);
        partial void PrepareSimulationSuiteControllerUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Vapi.UpdateSimulationSuiteDTO request);
        partial void ProcessSimulationSuiteControllerUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSimulationSuiteControllerUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.SimulationSuite> SimulationSuiteControllerUpdateAsync(
            global::System.Guid id,
        ...
        {
            var __response = await SimulationSuiteControllerUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse<global::Vapi.SimulationSuite>> SimulationSuiteControllerUpdateAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSimulationSuiteControllerUpdateArguments(
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SimulationSuiteControllerUpdateSecurityRequirements,
                operationName: "SimulationSuiteControllerUpdateAsync");
            ...
            if (xSimulationEntryPoint != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSimulationSuiteControllerUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SimulationSuiteControllerUpdate",
                                methodName: "SimulationSuiteControllerUpdateAsync",
                                pathTemplate: "$\"/eval/simulation/suite/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSimulationSuiteControllerUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSimulationSuiteControllerUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.SimulationSuite> SimulationSuiteControllerUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vapi.UpdateSimulationSuiteDTO
            {
                Name = name,
            ...
            return await SimulationSuiteControllerUpdateAsync(
                id: id,
                xClientSource: xClientSource,
                xSimulationEntryPoint: xSimulationEntryPoint,
                request: __request,
