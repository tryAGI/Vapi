...
namespace Vapi
{
    ...
    public sealed partial class ClientInboundMessageSay
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.ClientInboundMessageSayTypeJsonConverter))]
        public global::Vapi.ClientInboundMessageSayType? Type { get; set; }
        ...
        public ClientInboundMessageSay(
            global::Vapi.ClientInboundMessageSayType? type,
