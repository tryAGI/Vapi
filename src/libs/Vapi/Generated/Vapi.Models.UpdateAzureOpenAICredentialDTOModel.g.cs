    ...
    public static class UpdateAzureOpenAICredentialDTOModelExtensions
    {
        ...
        public static string ToValueString(this UpdateAzureOpenAICredentialDTOModel value)
        {
            return value switch
            {
                ...
                UpdateAzureOpenAICredentialDTOModel.Gpt56Luna20260709 => "gpt-5.6-luna-2026-07-09",
                UpdateAzureOpenAICredentialDTOModel.Gpt56Sol20260709 => "gpt-5.6-sol-2026-07-09",
                UpdateAzureOpenAICredentialDTOModel.Gpt56Terra20260709 => "gpt-5.6-terra-2026-07-09",
        ...
        public static UpdateAzureOpenAICredentialDTOModel? ToEnum(string value)
        {
            return value switch
            {
                ...
                "gpt-5.6-luna-2026-07-09" => UpdateAzureOpenAICredentialDTOModel.Gpt56Luna20260709,
                "gpt-5.6-sol-2026-07-09" => UpdateAzureOpenAICredentialDTOModel.Gpt56Sol20260709,
                "gpt-5.6-terra-2026-07-09" => UpdateAzureOpenAICredentialDTOModel.Gpt56Terra20260709,
                _ => null,
            };
        }
    }
