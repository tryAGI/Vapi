...
namespace Vapi
{
    ...
    /// </summary>
    public static class TalkscriberTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this TalkscriberTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static TalkscriberTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
