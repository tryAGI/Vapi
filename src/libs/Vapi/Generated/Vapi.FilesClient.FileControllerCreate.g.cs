...
namespace Vapi
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement s_FileControllerCreateSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_FileControllerCreateSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.File> FileControllerCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vapi.CreateFileDTO
            {
                File = file,
                Filename = filename,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Vapi.CreateFileDTO
            {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Vapi.File.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Vapi.File.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
