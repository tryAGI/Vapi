...
namespace Vapi
{
    ...
    public sealed partial class UpdateOrgDTO
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vapi.JsonConverters.UpdateOrgDTOChannelJsonConverter))]
        public global::Vapi.UpdateOrgDTOChannel? Channel { get; set; }
        ...
        public UpdateOrgDTO(
            ...
            string? name,
            global::Vapi.UpdateOrgDTOChannel? channel,
            double? billingLimit,
