    ...
    public static class WorkflowUserEditableCredentialDiscriminatorProviderExtensions
    {
        ...
        public static string ToValueString(this WorkflowUserEditableCredentialDiscriminatorProvider value)
        {
            return value switch
            {
                ...
                WorkflowUserEditableCredentialDiscriminatorProvider.Microsoft => "microsoft",
                ...
                WorkflowUserEditableCredentialDiscriminatorProvider.S3Compatible => "s3-compatible",
        ...
        public static WorkflowUserEditableCredentialDiscriminatorProvider? ToEnum(string value)
        {
            return value switch
            {
                ...
                "microsoft" => WorkflowUserEditableCredentialDiscriminatorProvider.Microsoft,
                ...
                "s3-compatible" => WorkflowUserEditableCredentialDiscriminatorProvider.S3Compatible,
