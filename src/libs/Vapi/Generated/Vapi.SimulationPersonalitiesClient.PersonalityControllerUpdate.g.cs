...
namespace Vapi
{
    public partial class SimulationPersonalitiesClient
    {
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement s_PersonalityControllerUpdateSecurityRequirement0 =
        ...
        private static readonly global::Vapi.EndPointSecurityRequirement[] s_PersonalityControllerUpdateSecurityRequirements =
            new global::Vapi.EndPointSecurityRequirement[]
            {                s_PersonalityControllerUpdateSecurityRequirement0,
            };
        ...
        partial void ProcessPersonalityControllerUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await PersonalityControllerUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vapi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vapi.AutoSDKHttpResponse<global::Vapi.Personality>> PersonalityControllerUpdateAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vapi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PersonalityControllerUpdateSecurityRequirements,
                operationName: "PersonalityControllerUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePersonalityControllerUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vapi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PersonalityControllerUpdate",
                                methodName: "PersonalityControllerUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPersonalityControllerUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vapi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPersonalityControllerUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vapi.Personality> PersonalityControllerUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vapi.UpdatePersonalityDTO
            {
                Name = name,
                Assistant = assistant,
                Path = path,
