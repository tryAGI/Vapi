...
namespace Vapi
{
    ...
    /// </summary>
    public static class ElevenLabsTranscriberLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this ElevenLabsTranscriberLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static ElevenLabsTranscriberLanguage? ToEnum(string value)
        {
            return value switch
            {
