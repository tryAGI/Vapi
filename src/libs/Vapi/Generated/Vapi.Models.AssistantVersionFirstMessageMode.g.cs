...
namespace Vapi
{
    ...
    /// </summary>
    public static class AssistantVersionFirstMessageModeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this AssistantVersionFirstMessageMode value)
        {
            return value switch
            {
                AssistantVersionFirstMessageMode.AssistantSpeaksFirst => "assistant-speaks-first",
                AssistantVersionFirstMessageMode.AssistantSpeaksFirstWithModelGeneratedMessage => "assistant-speaks-first-with-model-generated-message",
        ...
        /// </summary>
        public static AssistantVersionFirstMessageMode? ToEnum(string value)
        {
            return value switch
            {
                "assistant-speaks-first" => AssistantVersionFirstMessageMode.AssistantSpeaksFirst,
                "assistant-speaks-first-with-model-generated-message" => AssistantVersionFirstMessageMode.AssistantSpeaksFirstWithModelGeneratedMessage,
